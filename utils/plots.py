...
class Annotator:
    ...
    def box_label(self, box, ori=0.0, label='', color=(128, 128, 128), txt_color=(255, 255, 255)):
...
def save_one_box(xyxy, im, file='image.jpg', gain=1.02, pad=0, square=False, BGR=False, save=True):
